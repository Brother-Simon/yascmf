...
<div class="container-fluid main-content"><div class="social-wrapper">
  ...
  <div id="hidden-items">
    ...
    <div class="item widget-container fluid-height profile-widget">
      <div class="widget-content padded">
        <div class="profile-info clearfix">
          <span class="pull-left dynasty_icon bg-primary">唐</span>
          <div class="profile-details">
            <a class="user-name" href="#">唐太宗</a>
            <p>
                千古一帝，唐朝第二任皇帝
            </p>
            <em>
                <span class="badge">明君</span>
                <span class="badge">政治家</span>
            </em>
          </div>
        </div>
    ...
    <div class="item widget-container fluid-height social-entry">
      <div class="widget-content padded">
        <div class="profile-info clearfix">
          <span class="pull-left dynasty_icon bg-warning">宋</span>
          <div class="profile-details">
            <a class="user-name" href="#">为啥赵光义传给了赵匡胤</a>
            <p>
                千古一帝，唐朝第二任皇帝
            </p>
            <em>哥哥的Simon 发表于 2 天前</em>
          </div>
        </div>
        <p class="content">
            为啥赵光义把皇位传给了赵光义，这篇文章论述了
            <em><a href="http://www.baidu.com">更多</a></em>
        </p>
      ...
      <div class="comments padded">
        <div class="comment">
          <img width="40" height="40" class="social-avatar pull-left" src="dist/img/avatar.png" />
